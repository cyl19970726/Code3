/**
 * /clarify Prompt - 澄清 spec.md 模糊点
 * 基于 observer/.codex/prompts/clarify.md
 * 这是内置的审批机制：交互式问答，用户回答 = 批准内容
 */
...
This interactive Q&A stage reduces downstream rework risk. Skip only for exploratory spikes.`,
  arguments: [
    {
      name: 'arguments',
      description: 'Optional context for prioritization',
      required: false
    }
  ]
};
...
Context for prioritization: ${userArgs || ''}
`
      }
    }
  ];
...
export const clarifyPrompt: PromptDefinition = {
  prompt,
  handler
};
