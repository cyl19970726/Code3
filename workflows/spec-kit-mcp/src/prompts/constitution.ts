/**
 * /constitution Prompt - 更新宪法
 * 基于 observer/.codex/prompts/constitution.md
 */
...
Updates: .specify/memory/constitution.md and propagates changes to all templates.`,
  arguments: [
    {
      name: 'arguments',
      description: 'Principle updates or context',
      required: false
    }
  ]
};
...
export const constitutionPrompt: PromptDefinition = {
  prompt,
  handler
};
