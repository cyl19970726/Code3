/**
 * /implement Prompt - 执行任务
 * 基于 observer/.codex/prompts/implement.md
 */
  ...
  return [
    {
      ...
      content: {
        type: 'text',
        text: `The user input can be provided directly by the agent or as a command argument - you **MUST** consider it before proceeding with the prompt (if not empty).
...
export const implementPrompt: PromptDefinition = {
  prompt,
  handler
};
